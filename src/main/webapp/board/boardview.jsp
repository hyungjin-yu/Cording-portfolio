...
<body>
	...
	<input type="button" value="글 수정" onclick="location.href='boardModify.jsp?pg=<%=pg %>'">
	<input type="button" value="글 삭제" onclick="location.href='boardDelete.jsp?seq=' + <%=seq%> + '&pg=' + <%=pg%>">
	<% } %>
</body>
</html>